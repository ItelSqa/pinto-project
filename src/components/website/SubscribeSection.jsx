    ...
    <div className="relative">
      <div className="bg-[#C2D5E4] mt-60 py-20 ">
        <div className="container grid grid-cols-1 lg:grid-cols-2 md:grid-cols-2 sm:grid-cols-2">
          <div
            className={`w-full ${
              isMobileView ? "mt-[10rem]" : "mt-[18rem"
            } md:mt-0 sm:mt-0 lg:mt-0`}
          >
            {isMobileView ? (
              <div className="text-[#376489] flex flex-col items-center  withbeforetitle relative">
                <span className="absolute -top-6 font-extrabold md:text-[xl] text-2xl text-center bg-[#C2D5E4] py-2 px-2">
            ...
            <p className="text-[#274C69] text-base mb-12 font-montserrat md:w-[90%] mx-auto leading-[29px] font-semibold text-center mt-4">
              Get exclusive freebies, valuable updates on upcoming events, and
              tips to enhance your emotional intelligence journey. We respect
              your inbox and promise no spam - just the insights you need to
              thrive at home and work.
            </p>
