    ...
    <section className="speaker">
        ...
        <div className="container my-6">
          <div className="w-full flex flex-col justify-center sm:w-1/2 md:w-1/2 lg:w-1/2">
            ...
            <p className="text-[#274C69] text-lg font-medium leading-[24.1px] font-montserrat mt-3">
              Stephanie Pinto is a multi-award-winning Emotional Intelligence
              specialist and international speaker. She is the author of the
              best-selling book From Chaos to Connection, and host of the
              Emotionally Intelligent Parenting podcast.
              <br /> <br />
              Stephanie founded the global online community Let's Raise
              Emotionally Intelligent Kids in 2019. Since then, her social media
              platforms have collectively amassed over a quarter of a million
              followers.
              <br />
              She’s also the co-founder of two annual international parenting
              conferences
              <br />
            </p>
            <h3 className="font-mognolia text-3xl mt-4 text-[#376489] leading-[28px]">
              Chaos to Connection and
              <br />
      ...
      >
        <div className="container flex items-center justify-start md:py-28 md:pt-28 pt-5 md:flex-nowrap flex-wrap-reverse relative ">
          <div className="md:w-[55%] w-[90%] mx-auto md:absolute z-50 p-7 md:px-20 right-[3%] md:-translate-y-0 -translate-y-20">
            <div>
