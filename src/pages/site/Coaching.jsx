...
function Coaching() {
  return (
    <section className="coaching">
        ...
        <div className="pt-[7.26vw] pb-[7.26vw]">
          <div className="grid grid-cols-1 lg:grid-cols-2 md:grid-cols-2 sm:grid-cols-2">
            ...
            <div style={{ backgroundImage: `url("${evolveEmotion}")` }} className="py-4 bg-contain bg-no-repeat bg-right  gap-4 sectionContent pl-[2.943vw]">
              ...
              <h3 className="my-4 text-4xl font-normal font-mognolia text-newprimary">Self-paced Parent Coaching</h3>
              <div className="text-newprimary font-[500]">
                ...
                <h3 className="my-4 text-4xl font-normal font-mognolia text-newprimary">Total value $620</h3>
      ...
      <section style={{ backgroundImage: `url("${PrivateParentCoaching}")` }} className=" bg-[#F1E1E4] bg-contain bg-bottom-left bg-no-repeat parentcoach">
        <div className="container py-20">
          <div className="block sm:hidden md:hidden lg:hidden">
            <span className="flex items-center justify-center w-full h-full mb-6">
              <img src={ParentCoachImage} className="w-[90%]" />
            </span>
          </div>
          <div className="grid gap-10 lg:grid-cols-2 md:grid-cols-2 sm:grid-cols-2">
            <div className=" sectionContent pr-[52px]">
              ...
              <h3 className="my-4 text-4xl font-normal font-mognolia text-newprimary">I got you! Work with me. </h3>
      ...
      <section style={{ backgroundImage: `url("${CoolKidsAnxiety}")` }} className="bg-right-bottom bg-no-repeat coolkids">
        <div className="py-20 sectionWrapper">
          <div className="grid grid-cols-1 lg:grid-cols-2 md:grid-cols-2 sm:grid-cols-2">
            ...
            <div className="sectionContent pl-[56px]">
              ...
              <h3 className="my-4 text-4xl font-normal font-mognolia text-newprimary">Overcome Anxiety in children</h3>
        ...
        <div style={{ backgroundImage: `url("${EFTTappingSessions}")` }} className="container pt-[139px] pb-[150px]">
          <div className="grid grid-cols-1 lg:grid-cols-2 md:grid-cols-2 sm:grid-cols-2">
            <div className="sectionContent pr-[52px]">
              ...
              <h3 className="my-4 text-4xl font-normal font-mognolia text-newprimary">Free 30 min zoom consult</h3>
