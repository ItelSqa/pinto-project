    ...
    return (
      <section>
        ...
        <div className="flex flex-col items-center justify-center min-h-screen bg-gray-100 text-center p-6">
          ...
          <Link
            to="/blogs"
            className="inline-flex items-center px-6 py-3 bg-blue-500 text-lg font-semibold rounded-lg hover:bg-blue-600 transition-colors"
          >
            <i className="bi bi-arrow-left-circle mr-2"></i> Go Back Blogs
          </Link>
        </div>
      </section>
    );
        ...
        <div className="md:px-[8%]  flex flex-col-reverse md:flex-row-reverse items-center justify-end md:py-24 py-10 relative">
          ...
          <div className="md:basis-[45%]  w-full md:w-[760px] flex items-center">
            <img
              src={blog.imgSrc}
              alt="blog Image"
              className="w-full md:w-[760px] h-auto  "
            />
          </div>
        </div>
      </div>
      ...
      <div className="md:container md:mx-auto md:px-4 py-12">
        {blog.blogSections.map((section, index) => (
          ...
          >
            {/* Text Section */}
            <div
              className={` w-full ${section.image ? "md:w-[45%]" : "w-full"}`}
            >
              <h4
                className={`text-[28px]  leading-[39px] md:text-[50px] md:leading-[70.5px]  px-2  text-[#274C69] 
              ${
                index === 1
                  ? "font-montserrat text-[28px]  leading-[34px] md:text-[48px] md:leading-[86px] font-extrabold text-[#C1989F] mb-1"
                  : "font-mognolia mb-2"
              }`}
              >
                {section.heading}
