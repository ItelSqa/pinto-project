...
export function Hero() {
  const rating = 5; // Adjust the rating dynamically if needed

  return (
    <div
      className="relative flex items-center justify-center min-h-screen pt-32 bg-center bg-cover overflow-hidden" // Add overflow-hidden to prevent overflow
      ...
      <div className="container relative z-10 flex flex-col items-center gap-8 px-4 mx-auto lg:flex-row lg:gap-16">
        ...
        <div className="text-center lg:w-1/2 lg:text-left">
          <h1 className="mb-2 text-3xl font-extrabold text-[#376489] md:text-5xl lg:text-[60px]">
            EMOTIONALLY <br /> INTELLIGENT PARENTING
          </h1>
          ...
          <p className="mb-4 text-base text-[#274C69] font-medium md:text-lg lg:text-[20px]">
            Engaging, uplifting (and always relatable) episodes focused on
            emotional intelligence in parenting, featuring expert interviews,
            practical tips, and heartfelt stories to help you navigate the
            challenges of raising emotionally resilient kids.
          </p>
